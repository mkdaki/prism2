...
**詳細**: `docs/E2_User_Test_Plan.md` を参照

* [ ] E-2-1. 準備
  * [ ] テスト計画の最終確認（`E2_User_Test_Plan.md`）
  * [ ] ローカルDocker環境の動作確認
  * [ ] サンプルCSVの準備（単発分析用）
  * [ ] 定期スクレイピング対象の選定（不動産価格/競合商品価格/求人トレンド/EC在庫）
  * [ ] 初回スクレイピングの実施（基準データ作成）

* [ ] E-2-2. Week 1: 単発分析機能のテスト（ペルソナA, B）
...
* [ ] E-2-3. Week 2-3: 推移比較機能のテスト（ペルソナC・最重要）
  * [ ] 同一対象を継続スクレイピング（週2-3回 × 2週間）
  * [ ] 推移比較機能を実際に使用
  * [ ] シナリオ3: 定期スクレイピングデータの推移比較
    * [ ] 不動産価格の推移
    * [ ] 競合商品の価格変動
    * [ ] 求人市場のトレンド変化
    * [ ] ECサイトの在庫状況の変化
